    ...
    return(
        <>
            ...
            <div className={styles.newsPage}>
                <div className={styles.mediaBox} id="news" style={{backgroundImage: `url(${props?.imagePath?.data.attributes.url})`}}><h1>News</h1></div>
                {
                news.map((info , idx) => (
                    <>
                        <div key={idx} className={styles.newsContainer}>
                            <div
                                ...
                                style={{
                                    backgroundImage: `url(${info?.attributes?.newsMedia?.data?.attributes.url})`,
                                }}
                            ></div>
